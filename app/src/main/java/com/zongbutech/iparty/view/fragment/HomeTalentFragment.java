 ...
 */
public class HomeTalentFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener, IHomeTalentView {

    private HomeTalentAdapter mAdapter;
    public static String TAG = HomeTalentFragment.class.getSimpleName();
    private static HomeTalentFragment fragment;
