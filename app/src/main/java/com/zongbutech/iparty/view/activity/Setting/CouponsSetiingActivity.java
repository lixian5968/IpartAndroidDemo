...
public class CouponsSetiingActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_coupons_setiing);
        ButterKnife.bind(this);
        mUser = (User) getIntent().getSerializableExtra("User");


        showMyWaitDialog(ct);
        mIpartApi.IpartGetHongBao(1, Constants.PAZE_Roll,1)
