...
public class FavoritesSetiingActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_favorites_setiing);
        ButterKnife.bind(this);
        mUser = (User) getIntent().getSerializableExtra("User");


        showMyWaitDialog(ct);
        mIpartApi.getUserFavorites(1, Constants.PAZE_Roll)
