...
public class LxRoundImageView extends ImageView {
    ...
    public LxRoundImageView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public LxRoundImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        ct = context;
